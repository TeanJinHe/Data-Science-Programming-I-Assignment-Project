...
def Bill_window():
    ...
    Title = Label(window, text="ELECTRIC BILL", fg='blue', bd=10, bg='#7ea7fe',
    ...
    Label01 = Label(window, text="----------------------Details---------------------------", fg='blue', bg='#7ea7fe',
                    font=("Times New Roman", 12)).grid(row=2)
    Label02 = Label(window, text="--------------------------------------------------------", fg='blue', bg='#7ea7fe',
                    font=("Times New Roman", 12)).grid(row=3)
    Label03 = Label(window, text="      Consumption block                   Rate(RM/kWh)", fg='blue', bg='#7ea7fe',
                    font=("Times New Roman", 12)).grid(row=4)
    Label04 = Label(window, text="--------------------------------------------------------", fg='blue', bg='#7ea7fe',
                    font=("Times New Roman", 12)).grid(row=5)
    Label05 = Label(window, text="     First 200 kWh (1-200 kWh)              0.218", fg='blue', bg='#7ea7fe',
                    font=("Times New Roman", 12)).grid(row=6)
    Label06 = Label(window, text="     Next 100 kWh (201-300 kWh)             0.334", fg='blue', bg='#7ea7fe',
                    font=("Times New Roman", 12)).grid(row=7)
    Label07 = Label(window, text="     Next 300 kWh (301-600 kWh)             0.516", fg='blue', bg='#7ea7fe',
                    font=("Times New Roman", 12)).grid(row=8)
    Label08 = Label(window, text="     Next 300 kWh (601-900 kWh)             0.546", fg='blue', bg='#7ea7fe',
                    font=("Times New Roman", 12)).grid(row=9)
    Label09 = Label(window, text="     Next 901 kWh onwards                   0.571", fg='blue', bg='#7ea7fe',
                    font=("Times New Roman", 12)).grid(row=10)
    Label10 = Label(window, text="--------------------------------------------------------", fg='blue', bg='#7ea7fe',
                    font=("Times New Roman", 12)).grid(row=11)
    Label11 = Label(window, text="More than 600 kWh need include service tax 6 percent", fg='blue', bg='#7ea7fe',
                    font=("Times New Roman", 12)).grid(row=12)
